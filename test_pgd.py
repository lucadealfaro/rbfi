...
def pgd_attack(model, device, x_batch, target_batch, max_epsilon, loss_function,
    ...
    for start_idx in range(num_restarts):
        ...
        for iteration_idx in range(num_iterations):
            ...
            if target_batch.eq(prediction.view_as(target_batch)) < 1:
                print("*************** Attack successful at iteration: {} Epsilon: {} L1: {}".format(
                      iteration_idx,
...
def pgd_batch_attack(model, device, x_batch, target_batch, max_epsilon, loss_function,
                     num_iterations=1000, num_restarts=10):
    ...
    for start_idx in range(num_restarts):
        ...
        print("  Accuracy for epsilon {} after {} restarts: {}".format(
            max_epsilon, start_idx + 1, accuracy))
    print("Batch success for epsilon {}: {}".format(
